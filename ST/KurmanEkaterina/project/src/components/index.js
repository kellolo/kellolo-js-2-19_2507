export default () => {
    let app = new Vue({
        ...
        data: {
            catalogItems: [],
            basketItems: [],
            catalogUrl: 'https://raw.githubusercontent.com/solaft/static/master/JSON/catalog.json',
            basketUrl: 'https://raw.githubusercontent.com/solaft/static/master/JSON/basket.json',
            basketShown: false
        },
        methods: {
            get(url) {
