<template>
    <nav class="nav container d-none d-md-flex justify-content-center mt-3" id="navTop">
        <div class="navAll">
            ...
            <div class="dropNav">
                ...
                <div class="dropNavIn">
                    ...
                    <a href="">
                        <div>Super sale!</div>
                        <img src="https://raw.githubusercontent.com/Smolnyakov/static/master/online-store-api/imgs/Html-css-js%20online%20shop/navDrop.jpg" alt="nav img">
                    </a>
                </div>
            </div>
        </div>
