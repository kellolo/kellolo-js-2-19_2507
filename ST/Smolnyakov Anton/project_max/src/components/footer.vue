<template>
    <footer class="container px-0" id="footer">
        <div class="row col-12 px-0 my-5 no-gutters">

            <div class="col-12 px-0
                        col-lg-6">
                <div class="logo d-flex justify-content-center pb-3 justify-content-lg-start">
                    <a href="#" class="pr-2"><img src="https://raw.githubusercontent.com/Smolnyakov/static/master/online-store-api/imgs/Html-css-js%20online%20shop/logo.png" alt="logo"></a>
